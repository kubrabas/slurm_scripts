"""
Submit a classification training job to SLURM.

Usage:
    python3 submit_classification.py -c configs/classification/exp001.yml
    python3 submit_classification.py -c configs/classification/exp001.yml --dry-run
"""
...
WORKER_SH  = Path("/home/kbas/SlurmScripts/GraphNet/train_classification.sh")
...
def main() -> int:
    ...
    job_name = f"cls_{mc}_{geometry}_{exp_name}"
