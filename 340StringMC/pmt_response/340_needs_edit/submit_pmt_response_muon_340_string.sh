#!/bin/bash
#SBATCH --job-name=Muon_PMT_Response_Serial
#SBATCH --time=01:00:00
#SBATCH --account=def-nahee
#SBATCH --array=0-9818%50
#SBATCH --mem=16G
#SBATCH --cpus-per-task=1
#SBATCH --output=/home/kbas/scratch/340_string/logs/Muon_response/_%A_%a.out
#SBATCH --error=/home/kbas/scratch/340_string/logs/Muon_response/_%A_%a.out

set -euo pipefail
mkdir -p /home/kbas/scratch/340_string/logs/Muon_response
...
PYTHON_SCRIPT="/project/def-nahee/kbas/pone_offline/apply_POM_response_serial_340_string_muon.py"
