#!/bin/bash
#SBATCH --job-name=Electron_162_PMT_Response_Serial
#SBATCH --time=01:00:00
#SBATCH --account=def-nahee
#SBATCH --array=0-6883%50
#SBATCH --mem=16G
#SBATCH --cpus-per-task=1
#SBATCH --output=/home/kbas/scratch/160_string/logs/Electron_response/_%A_%a.out
#SBATCH --error=/home/kbas/scratch/160_string/logs/Electron_response/_%A_%a.out

set -euo pipefail
mkdir -p /home/kbas/scratch/160_string/logs/Electron_response
...
PYTHON_SCRIPT="/project/def-nahee/kbas/pone_offline/apply_POM_response_serial_160_string_electron.py"
