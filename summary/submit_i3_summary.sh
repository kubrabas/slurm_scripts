...
#SBATCH --output=/home/kbas/scratch/logs/summary_i3_%j.out
#SBATCH --error=/home/kbas/scratch/logs/summary_i3_%j.out

set -euo pipefail

OUTDIR="/project/def-nahee/kbas/Graphnet-Applications/Playground/Datasets"

LOGDIR="/home/kbas/scratch/logs"
mkdir -p "${LOGDIR}"
mkdir -p "${OUTDIR}"

echo "--- HOST: JOB=${SLURM_JOB_ID:-} HOST=$(hostname)"
echo "--- LOG: ${LOGDIR}/summary_i3_${SLURM_JOB_ID:-nojob}.out"
echo "--- OUTDIR: ${OUTDIR}"
...
PYTHON_SCRIPT="/project/def-nahee/kbas/Graphnet-Applications/Playground/Datasets/prepare_summary_for_I3.py"
