#!/bin/bash
#SBATCH --job-name=PQ340_muon_convert_merge_split
#SBATCH --time=12:00:00
#SBATCH --account=def-nahee
#SBATCH --mem=128G
#SBATCH --cpus-per-task=20
#SBATCH --output=/scratch/kbas/FinalParquetDatasets/logs/PQ340_muon_nonoise/%j.out
#SBATCH --error=/scratch/kbas/FinalParquetDatasets/logs/PQ340_muon_nonoise/%j.out
#SBATCH --open-mode=append

set -euo pipefail

LOGDIR="/scratch/kbas/FinalParquetDatasets/logs/PQ340_muon_nonoise"
mkdir -p "${LOGDIR}"
...
PYTHON_SCRIPT="/project/def-nahee/kbas/Graphnet-Applications/DataPreperation/Parquet/convert_340_pmt_to_parquet_muon.py"
