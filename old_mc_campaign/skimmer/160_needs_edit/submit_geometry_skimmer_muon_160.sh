#!/bin/bash
#SBATCH --job-name=MuonSkim160From340
#SBATCH --time=01:30:00
#SBATCH --account=def-nahee
#SBATCH --array=0-9818%50
#SBATCH --mem=16G
#SBATCH --cpus-per-task=1
#SBATCH --output=/home/kbas/scratch/160_string/logs/Muon_skim/_%A_%a.out
#SBATCH --error=/home/kbas/scratch/160_string/logs/Muon_skim/_%A_%a.out

set -euo pipefail
mkdir -p /home/kbas/scratch/160_string/logs/Muon_skim
mkdir -p /home/kbas/scratch/160_string/Muon_I3Photons
...
PYTHON_SCRIPT="/project/def-nahee/kbas/Graphnet-Applications/DataPreperation/subset_160/340_string_to_160_string_muon.py"
...
OUTDIR="/home/kbas/scratch/160_string/Muon_I3Photons"
