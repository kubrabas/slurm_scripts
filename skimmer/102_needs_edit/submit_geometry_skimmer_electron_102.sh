#!/bin/bash
#SBATCH --job-name=electron_skim_102_from_340
#SBATCH --time=02:00:00
#SBATCH --account=def-nahee
#SBATCH --array=0-6881%50
#SBATCH --mem=32G
#SBATCH --cpus-per-task=1
#SBATCH --output=/home/kbas/scratch/102_string/logs/electron_skim/_%A_%a.out
#SBATCH --output=/home/kbas/scratch/102_string/logs/electron_skim/_%A_%a.out

set -euo pipefail

flavor="electron"
sub_geometry="compact"
...
LOGFILE="${LOGDIR}/${input_base}_${SLURM_JOB_ID:-unknown}_${SLURM_ARRAY_TASK_ID:-unknown}.out"
